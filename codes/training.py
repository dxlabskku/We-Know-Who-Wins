...
if __name__ == "__main__":
    ...
    torch.save(train_loader, f'{save_dir}/final_{args.pred_min}_trainloader_home.pth')
    torch.save(train_loader2,f'{save_dir}/final_{args.pred_min}_trainloader_away.pth')
    torch.save(valid_loader, f'{save_dir}/final_{args.pred_min}_validloader_home.pth')
    torch.save(valid_loader2, f'{save_dir}/final_{args.pred_min}_validloader_away.pth')
    torch.save(test_loader, f'{save_dir}/final_{args.pred_min}_testloader_home.pth')
    torch.save(test_loader2, f'{save_dir}/final_{args.pred_min}_testoader_away.pth')
    ...
    torch.save(model.state_dict(), f'{save_dir}/final_{args.pred_min}.json')
    torch.save(model, f'{save_dir}/final_{args.pred_min}.pkl')
