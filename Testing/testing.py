...
model_dir = input("Provide your directory with trained model : ")
...
if __name__ == "__main__":
        if args.use_testloader == 'yes':
            loader_dir1 = input("Provide your directory with pre-made testloaders (Home) : ")
            loader_dir2 = input("Provide your directory with pre-made testloaders (Away) : ")
            loader = torch.load(f"{loader_dir1}")
            loader2 = torch.load(f"{loader_dir2}")
            ...
            if args.new_scaler == 'yes':
                ...
                scaler_dir = input('provide your directory with saved scaler : ')
